...
package org.apache.iceberg.fileformat.utils;
...
public class FileFormatUtils {
  ...
  public static CustomFileFormat fromFileName(FileFormatFactory factory, CharSequence filename) {
    for (CustomFileFormat format : factory.getAll()) {
